...
const initialState: MyState = {
  ...
  error: null,
  singleUser: null,
  createdUser: { name: '', job: '', id: '', createdAt: '' },
  formValue: { name: '', job: '' },
};
...
const mySlice = createSlice({
  ...
  initialState,
  reducers: {
    createNewUser: (state, action: PayloadAction<Partial<CreatedUser>>) => {
      state.createdUser = { ...state.createdUser, ...action.payload };
    },
    setFormValue: (state, action: PayloadAction<FormValue>) => {
